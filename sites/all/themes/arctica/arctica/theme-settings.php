...
function arctica_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['arctica_settings']['drupal']['core_css'] = array(
    ...
    '#type' => 'fieldset',
    '#description' => t('Select which stylsheets from Drupal core to disable. This helps you get rid of those list images, floats and ill placed paddings and margins.'),
  );
