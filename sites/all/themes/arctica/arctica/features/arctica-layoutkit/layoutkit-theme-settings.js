...
$(function() {
  ...
  $('#edit-responsive-enable').click( function() {
    if ($(this).attr('checked')) {
      $("#edit-layout.ui-tabs .ui-tabs-nav li:not(:first-child), .form-item-layout-query1").fadeIn();
    } else {
      $("#edit-layout.ui-tabs .ui-tabs-nav li:not(:first-child), .form-item-layout-query1").fadeOut();
    }
  });
